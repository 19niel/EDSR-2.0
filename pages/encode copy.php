                            ...
                            <div class="card p-4 shadow-sm mb-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        ...
                                        <select name="region" class="form-control form-select" id="region" required></select>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3" id="provinceContainer">
                                        ...
                                        <select name="province" class="form-control form-select" id="province" required></select>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        ...
                                        <select name="city" class="form-control form-select" id="city" required></select>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3" id="barangayContainer">
                                        ...
                                        <select name="barangay" class="form-control form-select" id="barangay"></select>
