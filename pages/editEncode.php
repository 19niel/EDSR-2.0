                ...
                <div class="row py-3">
                    <form id="editEncodeForm" action="../php/editEncodeAccount.php" method="POST">
                        ...
                        <div class="card p-4 shadow-sm mb-4">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <button type="button" class="btn btn-outline-primary btn-sm" id="addProductEntry" disabled>Add Another Product</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 text-end mt-4 mb-4 d-flex justify-content-end gap-2">
                            <a href="/e-dsr/pages/search.php" class="btn btn-light border px-4 shadow-sm fw-medium">Cancel</a>
