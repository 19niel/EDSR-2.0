...
<div class="main-content-card p-4 shadow-sm d-flex flex-column h-100 w-100">
    ...
    <div class="pipeline-container flex-grow-1 d-flex flex-column justify-content-center" style="min-height: 220px;">
        
        <div class="funnel-row-wrapper mb-2">
        ...
        <div class="funnel-row-wrapper mb-3">
            <div class="progress funnel-bar-track shadow-sm">
        ...
        <div class="funnel-legend-container mt-auto" style="display: flex; gap: 8px; justify-content: center; flex-wrap: wrap; font-size: 0.65rem; font-weight: 700; text-transform: uppercase;">
